...
- oauth2.jsoon file (you will need to create one in the project folder) : see the yahoo-fantasy-api (Authentication) documentation for setup: https://yahoo-fantasy-api.readthedocs.io/en/latest/authentication.html | Repo: https://github.com/spilchen/yahoo_fantasy_api
